    ...
    return (
        <div className="col-4">
            <div className="course-box">
                <Link to={`/course-info/${props.slug}`}>
                    {!isShowImg && (
                        <Skeleton
                ...
                <div className="course-box__main">
                    <Link to={`/course-info/${props.slug}`} className="course-box__title">{props.name}</Link>
                ...
                <div className="course-box__footer">
                    <Link to={`/course-info/${props.slug}`} className="course-box__footer-link">
                        مشاهده اطلاعات
